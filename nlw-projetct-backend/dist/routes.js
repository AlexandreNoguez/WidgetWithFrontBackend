...
const nodemailer_mail_adapter_1 = require("./adapters/node-mailer/nodemailer-mail-adapter");
const prisma_feedback_repositories_1 = require("./repositories/prisma/prisma-feedback-repositories");
...
exports.routes.post('/feedbacks', async (req, res) => {
    ...
    const prismaFeedbacksRepository = new prisma_feedback_repositories_1.PrismaFeedbacksRepository();
